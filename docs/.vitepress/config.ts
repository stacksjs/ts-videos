...
const title = 'vidx | A modern, fast reverse proxy. For a better local development environment.'
...
export default withPwa(
  defineConfig({
    ...
    head: [
      ...
      ['meta', {
        name: 'tags',
        content: 'vidx, stacksjs, reverse proxy, modern, lightweight, zero-config, local development',
      }],
